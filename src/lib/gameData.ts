  ...
  },
  {
    ...
    beats: [
      ...
      },
      {
        ...
        actionCue: '这是本幕最大雷点；AI 可根据演员状态生成借位、错位、删动作或加安全沟通后的版本。',
        riskTag: '必炸动作',
        mustKeep: true,
      },
      {
  ...
  },
  {
    ...
    beats: [
      ...
      },
      {
        ...
        actionCue: '如果前一幕没有真吻，这句必须变成“刚才那一下/这场难堪/你今晚站在这里”。',
        riskTag: '台词说不出口',
        mustKeep: true,
      },
      {
    ...
    beats: [
      {
        ...
        actionCue: '这是本幕最大动作雷点；可根据演员状态改成半跪、扶桌、深鞠躬或跪到一半被拦。',
        riskTag: '必炸动作',
        mustKeep: true,
      },
      {
    ...
    beats: [
      {
        ...
        actionCue: '如果前文强吻/反强吻被改掉，这句必须同步变形，不能机械保留“嘴”。',
        riskTag: '最炸台词',
        mustKeep: true,
      },
      {
  ...
  },
  {
    ...
    beats: [
      ...
      },
      {
        ...
        actionCue: '如果前文动作被工具改写，这里的排比必须同步改写。',
        riskTag: '总结前文事故',
        mustKeep: true,
      },
      {
      ...
      },
      {
        ...
        actionCue: '必须根据 canonLedger 复盘真实发生过的本局事故。',
        riskTag: '长台词难演',
        mustKeep: true,
      },
      {
